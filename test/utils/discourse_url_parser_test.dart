...
void main() {
  group('DiscourseUrlParser.parseTopic', () {
    ...
    test('parses canonical topic links and nested topic placeholder links', () {
      ...
      final nestedFragment = DiscourseUrlParser.parseTopic(
        'https://linux.do/n/topic/388420?sort=old#post_8',
      );
      expect(nestedFragment?.topicId, 388420);
      expect(nestedFragment?.postNumber, 8);
    ...
    test('canonicalizes complex topic links to stable topic paths', () {
      expect(
        DiscourseUrlParser.canonicalTopicPathFromUrl(
          'https://linux.do/n/topic/388420?sort=old',
        ),
        '/topic/388420',
      );
