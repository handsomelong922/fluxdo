...
/// - [enabled] 关闭时本组件退化为透传
class TopicProgressGestures extends StatefulWidget {
  const TopicProgressGestures({
    ...
    this.menuActions = _defaultMenuActions,
    this.swipeLeftAction = ProgressGestureAction.nextPost,
    this.swipeRightAction = ProgressGestureAction.previousPost,
    this.swipeUpAction = ProgressGestureAction.openTimeline,
  });
  ...
  final List<ProgressGestureAction> menuActions;
  final ProgressGestureAction swipeLeftAction;
  final ProgressGestureAction swipeRightAction;
  final ProgressGestureAction swipeUpAction;

  static const List<ProgressGestureAction> _defaultMenuActions = [
    ...
    ProgressGestureAction.readLater,
    ProgressGestureAction.search,
    ProgressGestureAction.refresh,
  ];

  @override
  State<TopicProgressGestures> createState() => _TopicProgressGesturesState();
}

enum _SwipeDirection { left, right, up }

class _TopicProgressGesturesState extends State<TopicProgressGestures>
  ...
  void _handleLongPressStart(LongPressStartDetails details) {
    ...
    final items = widget.menuActions
        .where((action) => action != ProgressGestureAction.none)
