...
bash "scripts/ci/patch_staged_flutter_sdk.sh" "${SOURCE_TREE_ROOT}"
bash "scripts/ci/patch_linux_plugins.sh"
python3 "scripts/ci/refresh_pub_advisories_cache.py" "${PUB_CACHE}"
python3 "scripts/ci/relocate_staged_pub_metadata.py" "${SOURCE_TREE_ROOT}"
python3 "scripts/ci/rebuild_linux_plugin_symlinks.py" "${SOURCE_TREE_ROOT}"
python3 \
